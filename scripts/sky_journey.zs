...
<tag:items:minecraft:swords>.add(<item:tconstruct:sword>);
<tag:items:c:tools/melee_weapons>.add(<item:tconstruct:sword>);
<tag:items:c:swords>.add(<item:tconstruct:sword>);
<tag:items:minecraft:tools>.add(<item:tconstruct:sword>);
<tag:items:c:tools>.add(<item:tconstruct:sword>);
